const trJSON={
  ...
  "pm.checks.0": "PM planlamasını günlük, haftalık, aylık, yıllık veya olaylara veya sayaç okumalarına dayalı olacak şekilde otomatikleştirin.",
  ...
  "frequency": "Sıklık",
  "every_frequency_days": "Her {{frequency}} günler",
  ...
  "loading_assets": "Altındaki varlıklar yükleniyor {{name}}{{id}}",
  ...
  "no_access_analytics": "Analytics'e erişiminiz yok. ",
  ...
  "REJECTED": "Reddedilmiş",
  "when_reading_is": "Sayaç Okuma ne zaman",
  ...
  "meter_create_success": "Sayaç başarıyla oluşturuldu",
  "meter_create_failure": "Sayaç oluşturulamadı ",
  "meter_edit_failure": "Sayaç düzenlenemedi",
  "meter_delete_success": "Sayaç başarıyla silindi",
  "meter_delete_failure": "Sayaç silinemedi",
  "next_reading_due": "Sonraki Okuma Zamanı",
  "unit_of_measurement": "Ölçü birimi",
  "last_reading": "Son Okuma",
  "enter_meter_name": "Metre adını girin",
  "unit": "Birim",
  "update_frequency": "Güncelleme sıklığı",
  "update_frequency_in_days": "Gün cinsinden Güncelleme Sıklığı",
  "required_meter_name": "Sayaç adı gerekli",
  "required_meter_unit": "Metre birimi gerekli",
  "required_meter_update_frequency": "Sayaç güncelleme sıklığı gerekli",
  "required_asset": "Varlık gerekli",
  "add_meter": "Metre Ekle",
  "add_meter_description": "Yeni bir Sayaç oluşturmak ve eklemek için aşağıdaki alanları doldurun",
  "edit_meter": "Metreyi Düzenle",
  "edit_meter_description": "Metreyi düzenlemek için aşağıdaki alanları doldurun",
  "confirm_delete_meter": "Bu Sayacı silmek istediğinizden emin misiniz?",
  "upgrade_create_meter": "Sayaçlar oluşturmak için yükseltme yapın",
  "history": "Tarih",
  ...
  "meter_details": "Sayaç ayrıntıları",
  "noRows.meter.message": "Sayaç okumaları size varlıkları izleme ve tanımlanmış koşullara göre yeni iş emirlerini tetikleme olanağı sağlar",
  "noRows.meter.action": "Bir Metre oluşturmak için '' düğmesine basın",
  "meter": "Metre",
  "drag_one_file": "Benzersiz bir dosyayı buraya sürükleyin",
  "drag_many_files": "Sürüklemek",
  ...
  "no_category_message": "Görünüşe göre sende hiç yok {{categoryName}} Henüz kategoriler.",
  ...
  "upgrade_analytics": "Analytics'i görmek için yükseltme yapın",
  ...
  "you_are_using_plan": "Şu anda kullanıyorsunuz {{planName}} plan.  {{expiration}}. ",
  ...
  "assigned_by": "Atayan",
  "percent_rows_have_value": "{{percent}}Satırların yüzdesi değere sahip",
  "match_at_least_column": "En az bir sütunla eşleşin",
  "to_import": "İçe aktarmak",
  "required_match": "{{field}} eşleştirme gerekli",
  "archived": "Arşivlendi",
  "import_wo_success": "{{created}} İş Emirleri oluşturuldu ve {{updated}} Güncellendi",
  "to_export": "Dışa aktarmak",
  "filters": "Filtreler",
  ...
  "import_meter_success": "{{created}} Sayaçlar oluşturuldu ve {{updated}} Güncellendi",
  ...
  "max_users_description": "En fazla etkinleştirebilirsiniz {{maxUsers}} kullanıcılar",
  "downgrade_description": "Az önce abonelik planınızın düzeyini düşürdünüz. ",
  "disable_users": "Kullanıcıları devre dışı bırak",
  "min_users_description": "En azını devre dışı bırakmalısınız {{minUsers}} kullanıcılar",
  ...
  "estimated_hours_in_text": "{{hours}} tahmini saatler",
  ...
  "remove_blank_meter_tasks": "Metre olmadan tip ölçerle görevleri kaldırın",
