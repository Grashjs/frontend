                  ...
                  <Grid container spacing={2}>
                    {user.superAccountRelations.map(superAccountRelation => <Grid item
                      ...
                      <CardContent sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
                        <Avatar variant="rounded" src={superAccountRelation.childCompanyLogo?.url} alt={superAccountRelation.childCompanyName} />
                        <Typography fontWeight={'bold'} sx={{my: 2}}>{superAccountRelation.childCompanyName}</Typography>
